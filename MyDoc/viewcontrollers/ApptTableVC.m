...
//  MyDoc
//
//  Created by Sudhan Raj on 15/11/12.
//  Copyright (c) 2012 MyDoc. All rights reserved.
//

#import "ApptTableVC.h"

#import "DataManager.h"

@interface ApptTableVC ()

@end

@implementation ApptTableVC
...
- (void) performLoginIfRequired {
    ...
    if (![dm isLoggedIn]) {
        ...
        [dm setApptVC: [self.navigationController viewControllers]];
